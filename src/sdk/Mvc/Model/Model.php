...
use sdk\Mvc\Model\Support\Dbal;
use sdk\Mvc\Model\Support\Field;
use sdk\Mvc\Model\Support\Finder;
...
class Model extends Object implements serializable, Finder
{
    ...
    public function init()
    {
        ...
        {
            $this->errorFileName($this->objectName());
        }
     ...
     *
     * @return array
     * @throws \sdk\Mvc\Model\Exception\ModelException
     */
