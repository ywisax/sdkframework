...
use sdk\Mvc\Route;
use sdk\Mvc\View;
use sdk\Base\Security\Valid;

/**
 * Pagination links generator.
 *
 * @package    Sdk/Pagination
 * @category   Base
 * @author     YwiSax
 */
class Pagination
{
     ...
     *
     * @param \sdk\Http\HttpRequest $request
     *
     * @return \sdk\Http\HttpRequest If used as getter
     ...
     * Route setter / getter
     *
     * @param \sdk\Mvc\Route $route
     *
     * @return \sdk\Mvc\Route Route if used as getter
