...
use sdk\Http\Request\Client\ExternalClient;
use sdk\Http\Request\Client\InternalClient;
...
class HttpRequest extends Object
{
    ...
    public function render()
    {
        ...
        {
            $this->headers('content-type', 'application/x-www-form-urlencoded; charset=' . Sdk::$charset);
        ...
        if (Sdk::$expose)
        {
            $this->headers('user-agent', Sdk::version());
        }
